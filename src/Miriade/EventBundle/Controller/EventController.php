...
class EventController extends Controller
{
	...
	/**
     * Trouve et affiche les informations d'un �v�nement enregistr� dans la base de donn�es.
     *
     * @Method("GET")
     * @Template()
     */
    public function showAction(Request $request, $id)
    {
        ...
        if (!$event) {
            throw $this->createNotFoundException('Impossible de trouver l\'�v�nement demand�.');
        }
